...
> CameraProfiler:Profile() -> [nil](https://create.roblox.com/docs/en-us/luau/nil)
...
> CameraProfiler:Set() -> [nil](https://create.roblox.com/docs/en-us/luau/nil)
...
> CameraProfiler:Get() -> [nil](https://create.roblox.com/docs/en-us/luau/nil)
